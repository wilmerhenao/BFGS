...
int main(int argc, char *argv[])
{
  ...
  typedef template<class T> void(*test_fun_ptr_type)(T*, T*, T*, int);

  test_fun_ptr_type<double> testFunction;
  test_fun_ptr_type<dd_real> thestFunctin_dd;
  ...
  */
  ...
  bfgs<double>(xf, fopt, n, lm, m, ftarget, gnormtol, maxit, J, taux, taud, 
	       echo, testFunction, datafilename, info);

  bfgs<dd_real>(xf_dd, fopt_dd, n, lm, m, ftarget_dd, gnormtol_dd, maxit, J, 
		taux_dd, taud_dd, echo, testFunction_dd, datafilename_dd, info_dd);
