...
extern "C" {
void yurirosen(double *f, double *g, double *x, int n)
{
...
void yurirosen_ns1(double *f, double *g, double *x, int n)
{
/*n = pars.nvar;
...
void yurirosen_ns2(double *f, double *g, double *x, int n)
{
